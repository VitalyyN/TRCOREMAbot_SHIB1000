...
- `/start_bot` - запустить торговлю. **Важно:** После любого перезапуска контейнера, остановки вручную или нажатия кнопок `Stop_...`, всегда необходимо нажимать кнопку `Start_bot` для возобновления торговли.
